...
function shuffle(array) {
  ...
  function displayResults(){
    document.getElementById("correct").innerHTML = `Правильных ответов: ${localStorage.getItem("correctAnswers")}`;
    document.getElementById("incorrect").innerHTML = `Неправильных ответов: ${localStorage.getItem("incorrectAnswers")}`;
    document.getElementById("name").innerHTML = `${localStorage.getItem("userName")}, ваш результат:`;
}
